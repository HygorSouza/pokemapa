...
<body>
	...
	<div id="main" class="container">
		...
		<form action="atualizar_local" method="post"
			...
			<input type="hidden" name=id value="${local.id}"> <input
				type="hidden" name=imagem value="${local.imagem}">
			<div class="row">
				<div class="form-group col-md-8">
					<label for="nome">Nome</label> <input type="text"
						class="form-control" name="nome" id="nome" required
						maxlength="128" value="${local.nome}" placeholder="nome do local">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label for="logradouro">Logradouro</label> <input type="text"
						...
						maxlength="128" value="${local.logradouro }"
						placeholder="nome do logradouro, sem cidade e estado">
			...
			<div class="row">
				<div class="form-group col-md-4">
					<label for="latitude">Latitude</label> <input type="number"
						class="form-control" name="latitude" id="latitude" step="0.000001"
						value="${local.latitude}" readonly placeholder="latitude do local">
				...
				<div class="form-group col-md-4">
					<label for="longitude">Longitude</label> <input type="number"
						...
						step="0.000001" value="${local.longitude}" readonly
					...
					<label for="cidade">Cidade: </label> <select id="cidade"
						...
						<c:forEach items="${cidades}" var="cidade">
							...
							<c:if test="${cidade.id eq local.cidade.id}">
								<option value="${cidade.id}" selected>${cidade.nome}-
									${cidade.estado.id}</option>
							</c:if>
						</c:forEach>
					</select>
			...
			<div class="row">
				<div class="form-group col-md-8">
					<label for="arquivo">Por favor, selecione um arquivo de
						imagem do tipo jpg para carregar:</label> <input type="file" name="file"
						id="arquivo" class="file" />
				</div>
			</div>
			<hr />
